...
namespace Aedis.App1.Application.Notifications.Events;

/// <summary>
///     Evento de follow-up publicado pelo worker após processar uma notificação com sucesso. Outros serviços
///     podem reagir a ele (encadeamento de processos).
/// </summary>
